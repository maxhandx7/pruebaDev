...
/**
 *   	\file       persona_list.php
 *		\ingroup    prueba
 *		\brief      List page for persona
 */
...
require_once __DIR__.'/class/persona.class.php';
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('prueba', 'persona', 'write');
	$permissiontodelete = $user->hasRight('prueba', 'persona', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
$title = $langs->trans("Personas");
//$help_url = "EN:Module_Persona|FR:Module_Persona_FR|ES:Módulo_Persona";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/prueba/persona_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/prueba/persona_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendPersonaRef";
$modelmail = "persona";
$objecttmp = new Persona($db);
