...
/**
 * \file    test/phpunit/PruebaFunctionalTest.php
 * \ingroup prueba
 ...
 * @package Testprueba
 */
class PruebaFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 500100; // TODO: autodetect?
	...
	{
		$this->url('/custom/prueba/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('prueba/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/prueba/admin/about.php');
		$this->authenticate();
		return $this->assertContains('prueba/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('pruebawidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modPrueba_PruebaTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modPrueba_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
